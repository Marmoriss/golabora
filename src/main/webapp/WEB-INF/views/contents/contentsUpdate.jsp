...
<section id="admin-contents-update">
	<h1>🔧 영화 컨텐츠 수정</h1>
	<div class="contents-container">
		<form 
		action="<%=request.getContextPath()%>/contents/contentsUpdate" 
		 method="POST" 
		 class="contentsUpdate"
		 name="contentsUpdateFrm"
		 enctype="multipart/form-data"
		 onsubmit="return confirm('이 영화를 수정하시겠습니까?');">
		 <h3>영화제목</h3>
		 	<input type="text" name="contentsTitle"/>
			 <div id="enroll-genre">
				<h3>장르</h3>		 
				<div>
